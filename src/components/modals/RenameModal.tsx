...
export const RenameModal: React.FC<RenameModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[110] bg-base/90 backdrop-blur-md flex items-end sm:items-center justify-center p-0 sm:p-6 animate-in fade-in">
      <div className="bg-inset border-t sm:border border-divider w-full sm:max-w-sm rounded-t-3xl sm:rounded-card p-6 space-y-5 shadow-2xl">
        ...
        <div className="flex gap-3">
          ...
          <button
            type="button"
            onClick={onConfirm}
            className="flex-[2] min-h-[48px] bg-accent rounded-2xl font-bold text-white active:scale-95 transition-all"
          >
