      ...
      <div className="space-y-4" data-testid="schedule-editor">
          ...
          <div className="flex items-center justify-between mb-2 gap-2 flex-wrap">
            ...
            <div className="flex items-center gap-1.5">
              <button
                ...
                className="inline-flex items-center gap-1 text-xs px-2.5 py-1.5 rounded-chip bg-accent text-white hover:opacity-90 active:scale-95 transition"
              >
        ...
        <div className="flex items-center justify-end gap-2 pt-2">
          ...
          <button
            ...
            className="px-4 py-2 rounded-control bg-accent text-white text-sm font-medium hover:opacity-90 active:scale-95 transition disabled:opacity-50"
          >
