...
**图标：同一个人形轮廓 + 朱砂高亮目标部位**，不是五个各自独立的部位图。
小尺寸下「孤立的胸肌」和「孤立的背肌」几乎无法区分，放进人形里立刻就清楚；
一套轮廓五种高亮，风格天然统一。胸与背轮廓相同，靠**脊柱线**区分正反面。

⚠️ 背阔第一版画成两条交于中心的斜线，离线栅格化一看整体是个「Y」，不像背。
改成从腋下向外张、往腰收的翼形。**图标必须真的渲染出来看**，光看路径数据判断不了。
