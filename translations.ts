...
export const translations: TranslationStrings = {
  ...
  scheduleDelete: { en: 'Delete plan', cn: '删除计划' },
  scheduleAddExercise: { en: 'Add exercise', cn: '添加动作' },
  ...
  assistantTab: { en: 'Assistant', cn: '智能助手' },
  assistantEmptyTitle: { en: 'How can I help your training?', cn: '需要我帮你做点什么？' },
  assistantEmptySubtitle: {
    en: 'I can read your workouts, PRs, body data and goals (read-only), and plan future training in your schedule.',
    cn: '我能读取你的训练记录、PR、身体数据和训练目标（只读），并帮你在日程表里安排未来的训练。',
  },
  assistantInputPlaceholder: { en: 'Ask anything about training…', cn: '问我关于训练的任何事…' },
  assistantSend: { en: 'Send', cn: '发送' },
  assistantNewConversation: { en: 'New conversation', cn: '新建对话' },
  assistantRename: { en: 'Rename', cn: '重命名' },
  assistantDelete: { en: 'Delete', cn: '删除' },
  assistantClear: { en: 'Clear messages', cn: '清空消息' },
  assistantConversations: { en: 'Conversations', cn: '历史对话' },
  assistantThinking: { en: 'Thinking…', cn: '思考中…' },
  assistantToolReading: { en: 'Reading data', cn: '读取数据' },
  assistantToolWriting: { en: 'Updating schedule', cn: '更新日程' },
  assistantApproveCreate: { en: 'Plan created', cn: '已添加计划' },
  assistantApprove: { en: 'Apply', cn: '应用' },
  assistantReject: { en: 'Reject', cn: '拒绝' },
  assistantApiNotConfigured: {
  ...
  assistantSuggestAdjust: { en: 'My knee hurts — adjust leg day', cn: '我膝盖有点疼，能调整一下腿日吗' },
  scheduleFromLibrary: { en: 'Pick from library', cn: '从动作库选择' },
  scheduleManualRow: { en: 'Manual entry', cn: '手动添加' },
  planConfirmTitle: { en: 'Plan completion', cn: '训练完成情况' },
  planConfirmSubtitle: { en: 'How did this scheduled session go?', cn: '本次计划训练的实际情况？' },
  planFaithful: { en: 'As planned', cn: '按计划完成' },
  planModified: { en: 'With adjustments', cn: '有调整' },
  planNotDone: { en: 'Cancel save', cn: '不保存' },
  planBadgeFaithful: { en: 'From plan', cn: '来自计划' },
  planBadgeModified: { en: 'Plan · adjusted', cn: '计划 · 有调整' },
